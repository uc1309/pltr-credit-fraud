...
# Code for Monte Carlo simulation on 100 simulated data samples
# Generates histograms of AP scores
#
# NOTE: File directory will need to be edited where appropriate.

# read_from_files taken from LeBorgne and Bontempi (2021)
# A method that simply reads in the simulated data into one 
# pandas DataFrame
...
# Matrix of average precision scores
APs = np.zeros((iterations, 4))
# RF train, RF test, Logist train, logist test

for i in range(1, iterations+1):
    print(i)
    # NOTE: CHANGE THIS FILE DIRECTORY TO APPROPRIATE DIRECTORY
